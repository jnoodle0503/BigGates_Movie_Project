...
<link rel="stylesheet" type="text/css" href="./styles/recoMovieStyle.css">
</head>
<body>
<%
/*
	...
	<div class="lst_wrap">
		<ul class="lst_detail_t1">
			<li>
				...
				<input type="checkbox" id="thumbCheckbox<%=s %>" name="checkbox" value='<%=recoMovie[s] %>' style="opacity:0; position:absolute; left:9999px;"/>
...
<div id = "submit">
	<input type="submit" value="관심 영화 등록"/>
</div>
</form>
